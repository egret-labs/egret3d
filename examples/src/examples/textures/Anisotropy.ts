    ...
    class Starter extends paper.Behaviour {
        ...
        public onAwake() {
            ...
            { // Sub camera.
                ...
                subCamera.cullingMask = paper.Layer.UserLayer10;
            ...
            { // Main camera.
                ...
                mainCamera.near = 1.0;
                mainCamera.cullingMask = paper.Layer.UserLayer11;
            ...
            { // Create game objects.
                ...
                rendererA.material = egret3d.Material.create(egret3d.DefaultShaders.MESH_PHONG)
                    ...
                    .setTexture(textureA)
                    ;
                gameObjectA.layer = paper.Layer.UserLayer10;
                ...
                rendererB.material = egret3d.Material.create(egret3d.DefaultShaders.MESH_PHONG)
                    ...
                    .setTexture(textureB)
                    ;
                gameObjectB.layer = paper.Layer.UserLayer11;
