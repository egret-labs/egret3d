        ...
        public onStart() {
            ...
            function onThemeLoadComplete() {
                ...
                async function showPannel(title: string) {
                    ...
                    const dbd = await RES.getResAsync("countdown_ske_json");
                    const dbt = await RES.getResAsync("countdown_tex_json");
                    const dbt2 = await RES.getResAsync("countdown_tex_png");
                    ...
                    const armature = dragonBones.EgretFactory.factory.buildArmatureDisplay("countdown")!;
                    armature.x = 300;
                    armature.y = 200;
