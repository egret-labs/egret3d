...
declare namespace egret.web {
    ...
    class WebGLDrawCmdManager {
         ...
         */
        pushChangeProgram(type: string, filter?: any): void;
    }
}
declare namespace egret.web {
    /**
    ...
    class WebGLRenderBuffer extends HashObject implements sys.RenderBuffer {
         ...
         */
        resize(width: number, height: number, useMaxSize?: boolean): void;
        $pushResize(width: number, height: number): void;
        /**
         * 获取指定区域的像素
         */
        getPixels(x: number, y: number, width?: number, height?: number): number[];
...
declare namespace egret.web {
    ...
    class WebGLRenderContext {
         ...
         * 第一次上传顶点数组标记量
         */
        firstTimeUploadVertices: boolean;
        /**
         * 当前program key值
         */
         ...
         */
        drawImageByRenderNode(node: sys.NormalBitmapNode): void;
        /**
         * 绘制Mesh
         */
        ...
        drawTextureByRenderNode(node: sys.TextNode | sys.GraphicsNode): void;
        /**
         * 绘制矩形（仅用于遮罩擦除等）
         */
        drawRect(x: number, y: number, width: number, height: number): void;
...
declare namespace egret.web {
    ...
    class WebGLRenderer implements sys.SystemRenderer {
        $currentBuffer: WebGLRenderBuffer;
        constructor();
        private nestLevel;
        /**
         * 渲染一个显示对象
         ...
         * 绘制一个显示对象
         */
        private drawDisplayObject(displayObject, offsetX, offsetY, isStage?);
        /**
         * @private
         */
