namespace egret3d {
    ...
    export class DefaultTextures extends paper.SingletonComponent {
        ...
        public initialize() {
            super.initialize();
            {
                const texture = Texture2D.createColorTexture("builtin/white.image.json", 255, 255, 255);
            ...
            {
                const texture = Texture2D.createColorTexture("builtin/gray.image.json", 128, 128, 128);
                texture._isBuiltin = true;
            ...
            {
                const texture = Texture2D.createGridTexture("builtin/grid.image.json");
                texture._isBuiltin = true;
            ...
            {
                const texture = Texture2D.createColorTexture("builtin/missing.image.json", 255, 0, 255);
                texture._isBuiltin = true;
