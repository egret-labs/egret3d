namespace egret3d.ammo {
    ...
    export abstract class TypedConstraint extends paper.BaseComponent {
        protected static readonly _helpVector3A: Vector3 = Vector3.create();
        protected static readonly _helpVector3B: Vector3 = Vector3.create();
        protected static readonly _helpVector3C: Vector3 = Vector3.create();
        protected static readonly _helpVector3D: Vector3 = Vector3.create();
        protected static readonly _helpQuaternionA: Quaternion = Quaternion.create();
        protected static readonly _helpQuaternionB: Quaternion = Quaternion.create();
        protected static readonly _helpMatrixA: Matrix4 = Matrix.create();
        protected static readonly _helpMatrixB: Matrix4 = Matrix.create();
        protected static readonly _helpMatrixC: Matrix4 = Matrix.create();
