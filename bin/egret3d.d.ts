...
declare namespace egret3d {
     ...
     *
     */
    const helpMatrixE: Matrix;
    /**
     *
     */
    const helpMatrixF: Matrix;
}
declare namespace paper {
    /**
     *
    ...
    abstract class BaseSystem<T extends BaseComponent> {
         ...
         *
         */
        protected readonly _gameObjectOffsets: {
            [key: string]: number;
        };
        /**
         *
         ...
         *
         */
        protected _onCreateComponent(component: T): boolean;
        /**
         *
         */
        protected _onDestroyComponent(component: T): boolean;
        /**
...
declare namespace paper {
    ...
    abstract class BaseComponent extends SerializableObject {
         ...
         *
         */
        static _injectGameObject: GameObject;
        /**
         * 组件挂载的 GameObject
         */
...
declare namespace egret3d {
     ...
     *
     */
    const helpVector2A: Vector2;
    /**
     *
     */
    const helpVector2B: Vector2;
    /**
     *
     */
    const helpVector2C: Vector2;
    /**
     *
     */
    const helpVector2D: Vector2;
}
declare namespace egret3d {
...
declare namespace paper {
     ...
     *
     */
    function serializeAsset(source: paper.Asset): {
        hashCode: number;
    };
    /**
     *
...
declare namespace egret3d {
     ...
     *
     */
    const helpVector4G: Vector4;
    /**
     *
     */
    const helpVector4H: Vector4;
}
declare namespace paper {
    /**
     * 组件实体系统的主入口
    ...
    class Application {
        ...
        private static readonly _laterCalls;
...
declare namespace paper {
    ...
    namespace EventPool {
         ...
         * 事件回调类型
         */
        type EventListener<T extends BaseComponent> = (component: T) => void;
        /**
         * 添加事件监听
         */
         ...
         */
        function dispatchEvent<T extends BaseComponent>(type: string, component: T): void;
    }
}
declare namespace egret3d {
    /**
...
declare namespace paper {
     ...
     *
     */
    const _executeInEditModeComponents: any[];
    /**
     * 标记组件是否在编辑模式也拥有生命周期。
     */
    ...
    class BehaviourSystem extends paper.BaseSystem<Behaviour> {
        ...
        protected readonly _interests: {
            componentClass: any;
            listeners: {
                type: EventPool.EventType;
                listener: (component: Behaviour) => void;
            }[];
        }[];
        private readonly _onEnableBehaviours;
        private readonly _resetBehaviours;
        private readonly _startBehaviours;
        private readonly _onDisableBehaviours;
        /**
         * @inheritDoc
         */
        protected _onCreateComponent(component: Behaviour): boolean;
        /**
         * @inheritDoc
         */
        protected _onDestroyComponent(component: Behaviour): boolean;
        /**
         * @inheritDoc
         */
        update(): void;
...
declare namespace egret3d {
    ...
    class RenderContext {
        ...
        private readonly matrix_v;
        private readonly matrix_p;
        private readonly matrix_mv;
        private readonly matrix_vp;
        /**
         *
         */
...
declare namespace egret3d {
    ...
    class MeshRendererSystem extends paper.BaseSystem<MeshRenderer | MeshFilter> {
        ...
        protected readonly _interests: ({
            ...
            listeners: ({
                type: paper.EventPool.EventType;
         ...
         * @inheritDoc
         */
        protected _onCreateComponent(component: MeshRenderer | MeshFilter): boolean;
        /**
         * @inheritDoc
         */
        protected _onDestroyComponent(component: MeshRenderer | MeshFilter): boolean;
...
declare namespace egret3d {
    ...
    class TrailRenderSystem extends paper.BaseSystem<TrailRender> {
         ...
         * @inheritDoc
         */
        protected _onCreateComponent(component: TrailRender): boolean;
        /**
         * @inheritDoc
         */
        protected _onDestroyComponent(component: TrailRender): boolean;
        /**
         * @inheritDoc
         */
        update(): void;
...
declare namespace egret3d {
    ...
    class SkinnedMeshRendererSystem extends paper.BaseSystem<SkinnedMeshRenderer> {
         ...
         * @inheritDoc
         */
        protected _onCreateComponent(component: SkinnedMeshRenderer): boolean;
        /**
         * @inheritDoc
         */
        protected _onDestroyComponent(component: SkinnedMeshRenderer): boolean;
        /**
         * @inheritDoc
         */
        update(): void;
...
declare namespace egret3d {
    ...
    class GLTFAsset extends paper.Asset {
         ...
         * 自定义 Mesh 的属性枚举。
         */
        static getMeshAttributeType(type: gltf.MeshAttributeType): gltf.AccessorType;
        /**
         *
         */
         ...
         * 从二进制数据中解析资源。
         */
        parseFromBinary(binary: ArrayBuffer): void;
        /**
...
declare namespace egret3d {
    ...
    class Mesh extends paper.SerializableObject {
        ...
        constructor(vertexCountOrVertices: number | Float32Array, indexCountOrIndices: number | Uint16Array | null, firstIndexCount: number, attributeNames: gltf.MeshAttributeType[], drawMode?: MeshDrawMode);
        constructor(vertexCountOrVertices: number | Float32Array, indexCountOrIndices: number | Uint16Array | null, attributeNames: gltf.MeshAttributeType[], drawMode?: MeshDrawMode);
        ...
        addSubMesh(indexOffset: number, indexCount: number, materialIndex?: number, sourceSubMeshIndex?: number): number;
        getVertexCount(subMeshIndex?: number): number;
        getVertexPosition(vertexIndex: number, subMeshIndex?: number, result?: Vector3): Vector3;
        setVertexPosition(vertexIndex: number, vertex: Vector3, subMeshIndex?: number): void;
        ...
        getAttributes(attributeType: gltf.MeshAttributeType, subMeshIndex?: number): Uint8Array;
        getIndices(subMeshIndex?: number): Uint16Array;
        getVertexAttribute<T extends (Vector4 | Vector3 | Vector2)>(vertexIndex: number, attributeType: gltf.MeshAttributeType, subMeshIndex?: number, result?: T): T;
        setVertexAttribute(vertexIndex: number, attributeType: gltf.MeshAttributeType, subMeshIndex: number, ...args: number[]): void;
        /**
         * 暂时实现在这里，应该下放到 web，并将此方法抽象。
         */
        uploadSubVertexBuffer(uploadAttributes: gltf.MeshAttributeType | (gltf.MeshAttributeType[]), subMeshIndex?: number): void;
        /**
         * 暂时实现在这里，应该下放到 web，并将此方法抽象。
         */
...
declare namespace egret3d {
    ...
    class AnimationSystem extends paper.BaseSystem<Animation> {
        ...
        protected readonly _interests: {
            ...
            listeners: {
                type: paper.EventPool.EventType;
                listener: (component: Animation) => void;
            }[];
        }[];
        /**
         * @inheritDoc
         */
        protected _onCreateComponent(component: Animation): boolean;
        /**
         * @inheritDoc
         */
        update(): void;
...
declare namespace egret3d {
    ...
    class Transform extends paper.BaseComponent {
         ...
         * 子类可通过重载此方法进行标脏状态传递
         */
        protected _onParentChange(_newParent: Transform | null, _oldParent: Transform | null): void;
        /**
         * @inheritDoc
         */
        deserialize(element: any): void;
...
declare namespace egret3d {
     ...
     * 可以用来绘制一些图标等
     */
    class GizmosSystem extends paper.BaseSystem<paper.BaseComponent> {
        /**
         * @inheritDoc
         */
        update(): void;
...
declare namespace egret3d.ShaderChunk {
    ...
    const packing = "const float PackUpscale = 256. / 255.;const float UnpackDownscale = 255. / 256.;\nconst vec3 PackFactors = vec3( 256. * 256. * 256., 256. * 256.,  256. );\nconst vec4 UnpackFactors = UnpackDownscale / vec4( PackFactors, 1. );\nconst float ShiftRight8 = 1. / 256.;\nvec4 packDepthToRGBA( const in float v ) {\n    vec4 r = vec4( fract( v * PackFactors ), v );\n    r.yzw -= r.xyz * ShiftRight8;    return r * PackUpscale;\n}\nfloat unpackRGBAToDepth( const in vec4 v ) {\n    return dot( v, UnpackFactors );\n}";
