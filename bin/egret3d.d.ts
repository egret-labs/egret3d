...
declare namespace egret3d {
    class DefaultShaders {
        ...
        private static _createColorShaderTemplate(url, renderQueue);
        private static _createDiffuseShaderTemplate(url, renderQueue);
        private static _createLambertShaderTemplate(url, renderQueue);
        private static _createParticleShaderTemplate(url, renderQueue);
        static init(): void;
    }
}
declare namespace egret3d {
