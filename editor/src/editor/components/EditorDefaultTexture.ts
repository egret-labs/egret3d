    ...
    export class EditorDefaultTexture extends SingletonComponent {
        ...
        public initialize() {
            {//TODO
                ...
                const texture = egret3d.Texture2D.createByImage("builtin/camera_icon.image.json", image, gltf.TextureFormat.RGBA,false, true, false);
            ...
            {//TODO
                ...
                // image.onload = function () { texture.uploadImage(image, false, true, true, false); };
                const texture = egret3d.Texture2D.createByImage("builtin/light_icon.image.json", image, gltf.TextureFormat.RGBA, false, true, false);
